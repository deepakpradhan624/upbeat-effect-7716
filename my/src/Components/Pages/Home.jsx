...
function Home() {
  ...
  return (
    <div>
        ...
        <div className="product-carousel">
          ...
          <div className="newtosalecontainer">
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/availability/54528593?w=400"
                alt="error"
              />
              <h4>BALBAIL</h4>
              <h5>$1476</h5>
            ...
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/product/21755026_234?w=400"
                alt="error"
              />
              <h4>BALBAIL</h4>
              <h5>$1476</h5>
            ...
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/product/40828647_1?w=400"
                alt="error"
              />
              <h4>BALBAIL</h4>
              <h5>$1476</h5>
            ...
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/product/22158392_111?w=400"
                alt="error"
              />
              <h4>BALBAIL</h4>
              <h5>$1476</h5>
      ...
      <h1>
        {" "}
        <hr /> Special Offers <hr />{" "}
      </h1>

      <div className="specialoffercontainer">
        <div className="specialoffersubdivs">
          <img
            src="https://cdn2.jomashop.com/media/catalog/product/cache/df24c858758eb768757877f23cd17493/c/r/creed-green-irish-tweed-creed-edp-spray-33-oz-100-ml-m-3508441001022.jpg?width=350&height=350"
            alt="error"
          />
        ...
        <div className="specialoffersubdivs">
          <img
            src="https://th.bing.com/th/id/R.de04c9c155596793e34e0c38c982d6db?rik=6%2f4NUO6HWs%2fFbA&riu=http%3a%2f%2fclipart-library.com%2fimages_k%2fsale-transparent-background%2fsale-transparent-background-2.png&ehk=NVO7fpq0QQK1ee%2bFavP6Ziq46zjk2h9ITgAwVgTxwlY%3d&risl=&pid=ImgRaw&r=0"
            alt="sale"
          />
          <h3>OMG! So Fresh!</h3>
        ...
        <div className="specialoffersubdivs">
          <img
            src="https://static.thcdn.com/images/small/webp/productimg/1600/1600/11418649-2134474458384024.jpg"
            alt="error"
          />
      ...
      <div>
        <div className="product-carousel">
          ...
          <div className="newtosalecontainer">
            ...
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/umedia/1686127s?w=400"
                alt="error"
              />
            </div>
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/umedia/1685556s?w=400"
                alt="error"
              />
            </div>
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/umedia/1685542s?w=400"
                alt="error"
              />
            </div>
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/umedia/1684927s?w=400"
                alt="error"
              />
            </div>
            <div className="newtosalesubdiv">
              <img
                src="https://cdn.modesens.com/umedia/1684387s?w=400"
                alt="error"
              />
            </div>
            <div className="newtosalesubdiv">
      ...
      <div className="installationpartcontainer">
        ...
        <div className="installationpartsubdivs">
          <h3>Install the ModeSens Browser Extension</h3>
